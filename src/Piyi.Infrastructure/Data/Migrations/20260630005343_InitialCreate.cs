        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdProvider = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: true),
                    LastSeenAddress = table.Column<string>(type: "text", nullable: true),
                    LastSeenLatitude = table.Column<decimal>(type: "numeric(10,7)", precision: 10, scale: 7, nullable: true),
                    LastSeenLongitude = table.Column<decimal>(type: "numeric(10,7)", precision: 10, scale: 7, nullable: true),
                    LostDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    Status = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    ContactPhone = table.Column<string>(type: "text", nullable: true),
                    RewardAmount = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetQrCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PetQrCodes_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepeatType = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetReminders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PetReminders_Pets_PetId",
                        column: x => x.PetId,
                        principalTable: "Pets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LostPetPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LostPetPhotos_LostPets_LostPetId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdEvents_UserId",
                table: "AdEvents",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AuthProviders_ProviderType_ProviderUserId",
                table: "AuthProviders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LostPetPhotos_LostPetId",
                table: "LostPetPhotos",
                column: "LostPetId");

            migrationBuilder.CreateIndex(
                name: "IX_LostPets_LastSeenLatitude_LastSeenLongitude",
                table: "LostPets",
                columns: new[] { "LastSeenLatitude", "LastSeenLongitude" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetQrCodes_Code",
                table: "PetQrCodes",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PetQrCodes_PetId",
                table: "PetQrCodes",
                column: "PetId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PetReminders_PetId",
                table: "PetReminders",
                column: "PetId");
