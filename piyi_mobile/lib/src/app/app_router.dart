...
final appRouterProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: PetDetailScreen.route, builder: (context, state) => PetDetailScreen(petId: state.pathParameters['id']!)),
      GoRoute(path: ReportLostPetScreen.route, builder: (context, state) => ReportLostPetScreen(petId: state.pathParameters['petId']!)),
      GoRoute(path: LostPetsScreen.route, builder: (context, state) => const LostPetsScreen()),
      GoRoute(path: LostPetDetailScreen.route, builder: (context, state) => LostPetDetailScreen(lostPetId: state.pathParameters['id']!)),
      GoRoute(path: ReportSightingScreen.route, builder: (context, state) => ReportSightingScreen(lostPetId: state.pathParameters['lostPetId']!)),
      GoRoute(path: BusinessesScreen.route, builder: (context, state) => const BusinessesScreen()),
      GoRoute(path: BusinessDetailScreen.route, builder: (context, state) => BusinessDetailScreen(businessId: state.pathParameters['id']!)),
      ...
      GoRoute(path: PushDiagnosticsScreen.route, builder: (context, state) => const PushDiagnosticsScreen()),
      GoRoute(path: MapScreen.route, builder: (context, state) => const MapScreen()),
    ],
  );
});
